...
" default {
hi Normal term=NONE cterm=NONE ctermbg=234 ctermfg=254 guibg=#151515 guifg=#DADAC8
...
hi Todo term=NONE cterm=italic ctermbg=None ctermfg=251 gui=bold,italic guibg=#2f5a69 guifg=fg
